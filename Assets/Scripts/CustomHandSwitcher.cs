...
namespace CurvedUI
{
    ...
    /// <summary>
    /// Based on the CurvedUIHandSwitcher script
    /// 
    ...
    /// </summary>
    public class CustomHandSwitcher : MonoBehaviour
    {
...
#pragma warning restore 0649
        ...
        void Update()
        {
            //Continuously update which hand is active (in case mode is switched between controllers & hands)
            SwitchHandTo(CurvedUIInputModule.Instance.UsedHand);
